...
def fetch_clients(con: Con, commit_id: int, target_id: int, file_id: int) -> pd.DataFrame:
    params = {
        "commit_id": commit_id,
        "target_id": target_id,
        "file_id": file_id,
...
def fetch_touches(con: Con, target_id: int) -> pd.DataFrame:
